...
static SPLAY_HEAD(ethertree, etherindex)
etherroot;

static int compare(struct etherindex *a, struct etherindex *b)
{
...
static struct ethernetcode codes[] =
		...
		{ 0x00002b, "crisp automation, inc" },
				...
				{ 0x00005a,
						"sk (schneider & koch in europe and syskonnect outside of europe)" },
				{ 0x00005b, "eltec" },
				...
				{ 0x000077,
						"interphase [used in other systems, e.g. mips, motorola]" },
				...
				{ 0x000080,
						"cray communications (formerly dowty network services) [also shows as harris (3m) (new) and/or imagen(?) elsewhere]" },
				{ 0x000081, "synoptics" },
				...
				{ 0x000085, "canon inc." },
				{ 0x000086,
						"gateway communications inc. (then megahertz & now 3com)" },
				{ 0x000087, "hitachi" },
				...
				{ 0x00008e,
						"solbourne(?), jupiter(?) (i've had confirming mail on solbourne)" },
				...
				{ 0x0000ac,
						"conware netzpartner [had apollo, claimed incorrect]" },
				...
				{ 0x0000ba, "siig, inc." },
				{ 0x0000bb,
						"tri-data systems inc. netway products, 3274 emulators" },
				...
				{ 0x0000d8,
						"old novell ne1000's (before about 1987?) (also 3com)" },
				...
				{ 0x0000ed, "april" },
				{ 0x0000ee,
						"network designers limited [also knx ltd, a former division]" },
				{ 0x0000ef, "alantec (now owned by foresystems)" },
				{ 0x0000f0, "samsung" },
				{ 0x0000f1, "magna computer corporation" },
				{ 0x0000f2,
						"spider communications (montreal, not spider systems)" },
				...
				{ 0x000168,
						"w&g (wandel & goltermann) [incorrect according to w&g]" },
				...
				{ 0x0020e0,
						"premax pe-200 (pcmcia ne2000-clone card, sold by infoexpress)" },
				...
				{ 0x00808c,
						"netscout systems (formerly frontier software development)" },
				...
				{ 0x0080c7, "xircom" },
				{ 0x0080c8,
						"d-link (also solectek pocket adapters, and linksys pcmcia)" },
				...
				{ 0x00a04b,
						"sonic systems inc. etherfe 10/100 pci for mac or pc" },
				...
				{ 0x00a0cc,
						"lite-on (used by macsense in adapter for mac, also seen in pcs)" },
				...
				{ 0x00c005,
						"livingston enterprises inc portmaster (oemed by cayman)" },
				...
				{ 0x00c00f,
						"qnx software systems ltd. [also quantum software systems ltd]" },
				...
				{ 0x00c01d,
						"grand junction networks, inc. (cisco catalyst also reported)" },
				...
				{ 0x00c063,
						"morning star technologies inc may be miswrite of 0003c6" },
				...
				{ 0x00e018,
						"asustek intel 82558-based integrated fast ethernet for wim" },
				...
				{ 0x00e02c,
						"ast - built into 5166m pc motherboard (win95 id's as intel)" },
				...
				{ 0x020701,
						"interlan [now racal-interlan] dec (unibus or qbus), apollo, cisco" },
				...
				{ 0x08004e,
						"bicc [3com bought bicc, so may appear on 3com equipment as well]" },
				...
				{ 0x2e2e2e,
						"laa (locally administered address) for meditech systems" },
				{ 0x3c0000, "3com" },
				{ 0x400003, "net ware (?)" },
				{ 0x444553, "micrsoft" },
				{ 0x444649, "dfi (diamond flower industries)" },
				{ 0x475443,
						"gtc (not registered!) (this number is a multicast!)" },
				{ 0x484453, "hds ???" },
				{ 0x484c00, "network solutions" },
				{ 0x4854e8, "winbond?" },
				{ 0x4c424c,
						"information modes software modified addresses (not registered?)" },
				...
				{ 0x800010,
						"at&t [misrepresented as 080010? one source claims this is correct]" },
				{ 0x80ad00,
						"cnet technology inc. (probably an error, see instead 0080ad)" },
...
static int ethernetcode_index(struct ethertree *etherroot,
		struct ethernetcode *code)
{
...
static uint32_t ethernetcode_find_best(struct etherindex **results, int size,
		int random)
{
...
uint32_t ethernetcode_find_prefix(char *vendor, int random)
{
...
ethernetcode_make_address(char *vendor)
{
	...
	if (p < address + ETH_ADDR_LEN)
	{
		...
		address[2] = prefix & 0xff;
		prefix >>= 8;
		address[1] = prefix & 0xff;
		prefix >>= 8;
		address[0] = prefix & 0xff;
		prefix >>= 8;
