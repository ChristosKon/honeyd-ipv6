...
struct personality_set{
	struct personality *person4;
...
struct personality *personality_find6(const char *);
...
/* tree containing the ipv4 (nmap) fingerprints */
static int
...
/* tree containing the ipv6 (nmap) fingerprints */
SPLAY_HEAD(perstree6, personality) personalities6;
SPLAY_PROTOTYPE(perstree6, personality, node, perscompare);

/* tree containing the xprobe ipv4 fingerprints */
